...
public class Drive_and_Push_Beacon_Red_Alliance extends LinearOpMode {
...
// This is where we align the robot to hit the beacon.  Change if needed.
        drive_distance(strafe_away, 38.0, 0.6);
        drive_distance(DRIVE_FORWARD, 36.0, 0.6);
        drive_distance(strafe_away, 11.0, 0.6);
        drive_distance(DRIVE_FORWARD, 5.25, 0.4);
...
/* This next part will strafe past the beacon then figure out which beacon button
  ...
  */
    ...
    /* This is going forward towards second beacon, change this if to close or to far to beacon
        drive_distance(DRIVE_FORWARD, 2.5, 0.4);
