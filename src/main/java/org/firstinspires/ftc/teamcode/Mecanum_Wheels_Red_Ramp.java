...
// Then turns the robot to the left and drives forward onto the ramp for 5 points
...
// We called this Red Ramp Mecanum Wheels because it is for if we are on the Red Alliance Team.


@Autonomous(name="Mecanum Wheels Red Ramp", group="Mecanum Wheels")
//@Disabled
public class Mecanum_Wheels_Red_Ramp extends LinearOpMode
{
...
// Step through each leg of the path, ensuring that the Auto mode has not been stopped along the way
        ...
        // Step 2:  Turn left for .75 seconds
